...
const CreateProfile = () => {
     ...
     const submit = async() =>{
      if (profileData.profileType && profileData.gender && profileData.dob && profileData.mobile){
            await axios.post('https://screiwo-backend.onrender.com/api/profile/create', {profileData, token: localStorage.getItem('token')}).then((res)=>(console.log(res))).catch((err)=>console.log(err))
     }}
